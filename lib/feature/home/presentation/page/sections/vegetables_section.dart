...
class VegetablesSectionScreen extends StatefulWidget {
  const VegetablesSectionScreen({super.key});
  @override
  State<VegetablesSectionScreen> createState() =>
      _VegetablesSectionScreenState();
}

class _VegetablesSectionScreenState extends State<VegetablesSectionScreen> {
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<HomeBloc, HomeState>(
        buildWhen: (previous, current) =>
            current is CategoriesVegetablesLoadedState ||
            current is CategoriesVegetablesLoadingState,
        builder: (context, state) {
          if (state is CategoriesVegetablesLoadedState) {
            var item = context
                .read<HomeBloc>()
