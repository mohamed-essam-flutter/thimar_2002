...
class FruitsSectionScreen extends StatefulWidget {
  const FruitsSectionScreen({super.key});
  @override
  State<FruitsSectionScreen> createState() => _FruitsSectionScreenState();
}

class _FruitsSectionScreenState extends State<FruitsSectionScreen> {
  @override
  void initState() {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<HomeBloc, HomeState>(
        buildWhen: (previous, current) =>
            current is CategoriesFruitsLoadedState ||
            current is CategoriesFruitsLoadingState,
        builder: (context, state) {
          if (state is CategoriesFruitsLoadedState) {
            var item =
                context.read<HomeBloc>().categoriesFruitsResponseModel?.data;
            return Column(
              children: [
                TextFormField(
